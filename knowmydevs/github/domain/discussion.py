...
class Discussion(SQLModel, table=True):
    ...
    answer_chosen_by_avatar_url: str | None = Field(None, max_length=1000)
    answer_chosen_by_html_url: str | None = Field(None, max_length=1000)
    ...
    state_reason: str | None = Field(None, max_length=30)
